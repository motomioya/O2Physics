...
struct dimuonall_data {
  ...
  HistogramRegistry registry{
    "registry", 
    {
      ...
      {"massdaikiPM", "massdaikiPM", {HistType::kTH1F, {{750, 0.0, 15.0}}}},
      {"massmooyaPM", "massmooyaPM", {HistType::kTH1F, {{750, 0.0, 15.0}}}},
  ...
  void process(aod::DimuonsAll const& dimuons)
  {
    for (auto& dimuon : dimuons) {
      ...
      //massdaikiPM
      if (dimuon.chi2MatchMCHMFT1() < 40 && dimuon.chi2MatchMCHMFT2() < 40) {
        if (dimuon.sign() == 0) {
          if (dimuon.eta1() >= -3.6 && dimuon.eta1() <= -2.5) {
            if (dimuon.eta2() >= -3.6 && dimuon.eta2() <= -2.5) {
              registry.fill(HIST("massdaikiPM"), dimuon.mass());
            }
          }
        }
      }
        ...
        if (dimuon.isAmbig1() == 0 && dimuon.isAmbig2() == 0) {
          if (dimuon.chi2MatchMCHMFT1() < 50 && dimuon.chi2MatchMCHMFT2() < 50) {
            if (dimuon.eta1() >= -3.6 && dimuon.eta1() <= -2.5) {
              if (dimuon.eta2() >= -3.6 && dimuon.eta2() <= -2.5) {
                if (dimuon.sign() == 0) {
                  registry.fill(HIST("massmooyaPM"), dimuon.mass());
